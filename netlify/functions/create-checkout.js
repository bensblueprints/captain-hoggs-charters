    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{
        price_data: {
          currency: 'usd',
          product_data: {
            name: (businessName || "Captain Hogg's Charter Service") + ' - Trip Deposit',
            description: 'Deposit for ' + (tripType || 'fishing trip') + ' on ' + (tripDate || 'TBD') + ' with ' + (businessName || "Captain Hogg's Charter Service"),
          },
