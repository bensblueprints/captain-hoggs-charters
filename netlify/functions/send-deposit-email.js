...
exports.handler = async (event) => {
  ...
  try {
    ...
    const businessName = bizName || "Captain Hogg's Charter Service";
    const captainPhone = phone || '(757) 876-1590';
  ...
  <div style="max-width:600px;margin:0 auto;padding:2rem;">
    <div style="background:#0b1a2e;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.15);">
      ...
      <div style="padding:1.5rem 2rem;">
        ...
        <p style="color:#64748b;font-size:0.85rem;line-height:1.6;text-align:center;">This deposit is refundable up to 7 days before your trip date. If you have any questions, call or text Captain Hogg at <a href="tel:+17578761590" style="color:#0ea5e9;text-decoration:none;">${captainPhone}</a>.</p>
      </div>

      <!-- Footer -->
      <div style="padding:1.5rem 2rem;border-top:1px solid rgba(255,255,255,0.06);text-align:center;">
        <p style="color:#475569;font-size:0.75rem;margin:0;">&copy; ${new Date().getFullYear()} ${businessName}. Virginia Beach, Virginia.</p>
